    ...
    return (
      <div className="max-w-3xl mx-auto px-4 py-20 text-center space-y-5">
        ...
        <p className="text-xs text-neutral-500 max-w-sm mx-auto">
          Explore our collection of 240+ GSM heavyweight t-shirts engineered for modern builders.
        </p>
        <button
        ...
        <div className="flex items-center justify-between text-xs font-bold">
          <div className="flex items-center gap-2 text-neutral-900">
            ...
            {freeShippingRemaining > 0 ? (
              <span>
                Add <strong className="text-neutral-950">${freeShippingRemaining.toFixed(2)}</strong> more to unlock <strong>Free Standard Shipping</strong>
              </span>
            ) : (
              <span className="text-emerald-700 font-bold flex items-center gap-1">
                <Check className="w-4 h-4" /> You've qualified for Free Expedited Shipping!
              </span>
            )}
          </div>
                      ...
                      <button
                        onClick={() =>
                          toggleWishlist({
                            ...
                            description: '',
                            sizes: [item.size],
                            colors: [{ name: item.color, hex: '#111' }],
                            variants: [],
          ...
          <div className="bg-white rounded-xl border border-neutral-200 p-5 space-y-4 shadow-xs">
            ...
            <div className="space-y-2.5 text-xs text-neutral-600">
              ...
              <div className="border-t border-neutral-200 pt-3 flex justify-between items-baseline">
                ...
                <span className="text-xl font-black text-neutral-950">${total.toFixed(2)}</span>
              </div>
            </div>
